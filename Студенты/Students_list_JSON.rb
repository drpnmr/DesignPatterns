...
class Students_list_JSON
  ...
  # d. get_k_n_student_short_list Получить список k по счету n объектов класса Student_short
...
# Assuming a class Student and a class Student_short are defined elsewhere
# student = { 'id' => 1, 'last_name_initials' => 'Pnmr D.S.', 'git' => 'darya.pnmr', 'contact' => 'darya.pnmr@gmail.com' }

# file_path = 'students_list.json'
# students_list = Students_list_JSON.new(file_path)
